    ...
    >
      ...
      >
        <div className={styles['container']}>
          <img
            alt="image"
            src="409bb369-f4c0-4878-9c6f-e088ed8524ba"
          ...
          <div className={styles['SocialMedia']}>
            <span className={styles['text01']}>Follow us</span>
        ...
        <div className={styles['Links']}>
          <div className={styles['container2']}>
            ...
            <span className={projectStyles['footer-link']}>Features</span>
            <span className={projectStyles['footer-link']}>Blog</span>
            <span
          ...
          <div className={styles['container3']}>
            <span className={styles['text08']}>Resources</span>
            ...
            <span className={projectStyles['footer-link']}>iOS Version</span>
            <span
              className={` ${styles['text13']} ${projectStyles['footer-link']} `}
            >
              Android Version
            </span>
          </div>
